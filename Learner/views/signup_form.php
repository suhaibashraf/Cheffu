    ...
    <div class="row" style = "margin-top: 75px; padding-left: 100px; padding-right: 100px"">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "padding-bottom : 200px;">
            <div id="contactus">
                ...
                <hr>
                <form role="form" method="post" action="<?php echo base_url();?>Learner/form_validate" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" pattern="[a-zA-Z]+" title="Only English Alphabats are allowed" class="form-control" placeholder="Your First Name" name="firstname" value="<?php echo set_value('firstname'); ?>" required />
                        <?php echo form_error('firstname', '<div class="alert alert-danger contact-warning">', '</div>'); ?>
                    </div>

                    <div class="form-group">
                        <input type="text" pattern="[a-zA-Z]+" title="Only English Alphabats are allowed" class="form-control" placeholder="Your Last Name" name="lastname" value="<?php echo set_value('lastname'); ?>" required />
                    ...
                    <div class="form-group">
                        <input type="password" pattern="[0-9a-zA-Z]{8,}" class="form-control" placeholder="Select Password" name="password" value="<?php echo set_value('email'); ?>" required />
